...
function playerDetails() {
    ...
    const setCurrentWeaponOne = () => (currentWeapon = playerInfo.playerOne.getPlayerWeapon());
    const setCurrentWeaponTwo = () => (currentWeapon = playerInfo.playerTwo.getPlayerWeapon());
    return {
        playerOne,
        playerTwo,
        getCurrentWeapon,
...
function display() {
    ...
    const items = () => gameBoardDisplay.forEach((el) => el.addEventListener("click", changeDisplayItems));
    ...
    const remove = () => gameBoardDisplay.forEach((el) => el.removeEventListener("click", changeDisplayItems));
